...
plt.bar(nodes - bar_width/2, authority, bar_width, label='Authority', color='aqua')
plt.bar(nodes + bar_width/2, hub, bar_width, label='Hub', color='yellow')
plt.xlabel('Node')
plt.ylabel('Scores')
...
<img width="878" height="723" alt="image" src="https://github.com/user-attachments/assets/f2043786-c773-4425-a572-f69234e757ef" />
